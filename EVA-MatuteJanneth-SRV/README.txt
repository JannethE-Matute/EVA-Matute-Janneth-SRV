...
a persistence unit "EVA-MatuteJanneth-SRVPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/pweb/EVA_MatuteJanneth_SRV/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "EVA-MatuteJanneth-SRV/pom.xml":
...
artifact ("EVA-MatuteJanneth-SRV.war") is already built. You can build
